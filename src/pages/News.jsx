...
const News = () => {
  ...
  return (
    <div>
      ...
      <div style={{ fontFamily: 'Inter, sans-serif' }} className="news-container p-6 max-w-6xl mx-auto   ">
        <h1 className="text-3xl font-bold text-center mb-6 mt-24 md:mt-28 font-['FlatterySerif']">Latest News</h1>
